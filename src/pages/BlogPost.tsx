...
const blogContent: Record<string, BlogData> = {
  'sel-in-schools-lumi6': {
    ...
    sections: [
      ...
      { type: 'paragraph', content: 'A 19-year longitudinal study found that kindergarteners with strong social-emotional skills were more likely to graduate high school, obtain college degrees, and secure stable employment—and less likely to need public assistance or have criminal justice involvement.' },
      ...
      { type: 'paragraph', content: 'Every student has different social-emotional strengths and growth areas. Lumi6 generates personalized recommendations for skill development, providing both students and teachers with targeted resources. Whether a student needs support with self-regulation, empathy development, or conflict resolution, Lumi6 guides the way.' },
      ...
      { type: 'paragraph', content: 'We\'re preparing students for a world that demands more than academic knowledge. The jobs of tomorrow—and the challenges they\'ll face—require emotional intelligence, collaboration, and resilience. SEL isn\'t a nice-to-have; it\'s essential preparation for life.' },
